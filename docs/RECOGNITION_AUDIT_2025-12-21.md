...
>
> Этот аудит проводился до внедрения **All-Faces-Indexed Architecture (v6.0)**.
> Многие проблемы были исправлены в версиях v6.0 и v6.1.
>
> **Что исправлено:**
> - ✅ Race condition с rebuild_players_index — теперь используется `update_metadata()` без rebuild
> - ✅ Race condition с quality_filters — требует threading.Lock (документировано как future task)
> - ✅ Empty index handling — добавлен `initialize_empty()` (v6.1)
> - ✅ Singleton broken в photo_faces.py — исправлен через DI (v6.1)
> - ✅ auto-recognize не синхронизировал индекс — исправлен (v6.1)
>
> **Актуальная документация:** `python/ARCHITECTURE.md`, `docs/RECOGNITION_SUMMARY.md`
