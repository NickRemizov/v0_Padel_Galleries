...
| `insightface_det_score` | double precision | YES | **Оценка качества детекции InsightFace (det_score)** ⭐ |
...
- **`insightface_det_score`** — detection score от InsightFace (насколько уверен что это лицо)
