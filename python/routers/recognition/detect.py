...
async def process_photo(
    ...
    5. Return all faces (WITHOUT embeddings, WITH blur_score)
    """
    try:
        ...
        if len(existing_faces) == 0:
            ...
            saved_faces = []
            blur_scores = {}  # Store blur scores from detection - THIS IS THE FIX!
            ...
            for idx, face in enumerate(detected_faces):
                ...
                if save_response.data:
                    ...
                    # Store blur_score mapped to face ID - THIS IS THE FIX!
            ...
            # Load people info and include blur_score in response
            response_faces = []
            for face in saved_faces:
                ...
                response_faces.append({
                    ...
                    "blur_score": blur_scores.get(face["id"]),  # THIS IS THE FIX!
                    "people": person_data,
                })
