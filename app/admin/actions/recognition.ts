...
export async function getUnknownFaceClustersAction() {
  logger.warn("actions/recognition", "getUnknownFaceClustersAction not implemented yet")
  return { success: true, data: [] }
}

export async function assignClusterToPersonAction(clusterFaces: any[], personId: string) {
  logger.warn("actions/recognition", "assignClusterToPersonAction not implemented yet")
  return { success: true }
}

export async function rejectFaceClusterAction(clusterFaces: any[]) {
  logger.warn("actions/recognition", "rejectFaceClusterAction not implemented yet")
  return { success: true }
}

export async function regenerateUnknownDescriptorsAction() {
